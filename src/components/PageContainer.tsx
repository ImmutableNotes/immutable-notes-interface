    ...
    <div className="min-h-screen">
      <header className="bg-white shadow">
        <div className="flex mx-auto justify-between items-center max-w-5xl md:p-4">
          <Hambuger open={menuOpen} onChange={(b) => menuOpenSet(b)} />
      ...
      {menuOpen && (
        <>
          <div className="bg-tinted md:hidden absolute h-screen w-screen" onClick={() => menuOpenSet(false)} />
          <div className="bg-white md:hidden absolute w-screen shadow">
            {searchBar}
            <WalletButton menu onConnect={() => menuOpenSet(false)} />
